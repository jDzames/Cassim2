...
import sk.upjs.ics.s.jdzama.Cassim2.Commands.redo.CommandGomory;
...
import sk.upjs.ics.s.jdzama.Cassim2.Commands.redo.CommandStartSuppRole;
...
public class SavedSolutionReader {
    ...
    public void readForEdit(File file) throws FileWritingException{
        try {            
    ...
    public void readForSolution(File file, Stack<Command> redoStack) {
        try {
            FileReader reader = new FileReader(file);
            bufReader = new BufferedReader(reader);
